...
const CIRCUITS = [
  ...
  { id:'excursion-lac-rose', title:'Excursion Lac Rose', subtitle:'Sel, dunes & baignade',
    ...
    short:'Récolte du sel avec les ramasseuses, baignade dans l’eau saline, quad optionnel sur les dunes.',
  ...
  { id:'gambie-2j', title:'Gambie — Banjul & Juffureh', subtitle:'2 jours · fleuve, bac & mémoire de « Racines »',
    ...
    itinerary:[
      { n:1, title:'Dakar → Banjul', short:'Départ le matin vers la Gambie par Rufisque, Mbour et Kaolack. Visite des villages MANDINGUES de Sokone, Karang et Barra, puis traversée pittoresque du fleuve Gambie en bac jusqu’à Banjul, la capitale. Tour de la ville avant l’installation à l’hôtel. Dîner et nuit à Banjul.', tone:'dusk', mood:'city', img: 'images_du_senegal/photos_act_book/gambia/monument-01.jpg' },
      { n:2, title:'Banjul → Juffureh → Dakar', short:'Après le petit-déjeuner, nouvelle traversée du fleuve à la rencontre des ethnies de ses rives, jusqu’à Juffureh, sur la rive nord : le village natal de Kunta Kinteh, l’ancêtre d’Alex Haley, que son best-seller « Racines » a fait connaître au monde. Visite du village et de l’île de Kunta Kinteh (ex-James Island), puis route du retour vers Dakar avec déjeuner dans la région du Saloum.', tone:'terre', mood:'portrait', img: 'images_du_senegal/photos_act_book/gambia/site-01.jpg' },
    ] },
  ...
  // ---- GRANDS VOYAGES (brochure ACT « NEW BOOK ANGLAIS ») -----------------
  // Longs circuits thématiques & multi-pays. Programmes jour par jour fidèles
  // à la brochure. FR + EN fournis (IT/DE se replient sur EN via la cascade
  // i18n). Titres de jour = itinéraire (proches dans toutes les langues).
  { id:'rythme-danse-9j', title:'Rythme & Danse du Sénégal', subtitle:'9 jours · musiques et danses, du Saloum à la Casamance',
    days:9, nights:8, priceXOF:null, tone:'terre', mood:'portrait',
    badges:['Culture vivante','Musique & danse','2 pays'],
    short:'Neuf jours à la rencontre des musiques et danses qui racontent les peuples du Sénégal : Yela PEUL du Saloum, Ngoyane SÉRÈRE, kora MANDINGUE en Gambie, rythmes sacrés et Inconting de Casamance — cette racine du blues.',
    route:'Dakar → Saloum → Gambie → Casamance → Saly',
    types:['culture','aventure'], tier:'confort', start:'dakar', destIds:['dakar','saloum','casamance'], popularity:83,
    img: IMG('Casamance', 5),
    itinerary:[
      { n:1, title:'Dakar', tone:'dusk', mood:'city', img: IMG('Dakar', 8) },
      { n:2, title:'Dakar → Saloum', tone:'rose', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:3, title:'Îles du Saloum', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 1) },
      { n:4, title:'Saloum → Gambie (Banjul)', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 7) },
      { n:5, title:'Banjul → Ziguinchor', tone:'forest', mood:'leaves', img: IMG('Casamance', 1) },
      { n:6, title:'Basse Casamance', tone:'forest', mood:'water', img: IMG('Casamance', 3) },
      { n:7, title:'Ziguinchor → Saly', tone:'ocre', mood:'horizon', img: IMG('Casamance', 2) },
      { n:8, title:'Saly', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 5) },
      { n:9, title:'Saly & départ', tone:'sand', mood:'horizon', img: IMG('Lac Rose', 4) },
    ] },

  { id:'face-du-senegal-8j', title:'Le Visage du Sénégal', subtitle:'8 jours · Gorée, Saint-Louis, Touba & le Saloum',
    days:8, nights:7, priceXOF:null, tone:'terre', mood:'city',
    badges:['Grand classique','UNESCO','Guide local'],
    short:'Le tour de référence du pays : Dakar et Gorée, le Lac Rose, Saint-Louis et le parc du Djoudj, la ville sainte de Touba, puis le delta du Saloum et Joal-Fadiouth — huit jours pour saisir tous les visages du Sénégal.',
    route:'Dakar → Saint-Louis → Touba → Saloum → Saly',
    types:['culture','nature','diaspora'], tier:'confort', start:'dakar', destIds:['dakar','goree','lac-rose','saint-louis','saloum'], popularity:95,
    img: IMG('Saint-Louis', 2),
    itinerary:[
      { n:1, title:'Arrivée à Dakar', tone:'dusk', mood:'city', img: IMG('Dakar', 7) },
      { n:2, title:'Dakar & Gorée', tone:'terre', mood:'horizon', img: IMG('Ile de gorée', 8) },
      { n:3, title:'Dakar → Lac Rose → Saint-Louis', tone:'rose', mood:'water', img: IMG('Lac Rose', 3) },
      { n:4, title:'Saint-Louis & parc du Djoudj', tone:'terre', mood:'city', img: IMG('Saint-Louis', 5) },
      { n:5, title:'Saint-Louis → Touba → Kaolack', tone:'sand', mood:'horizon', img: IMG('Dakar', 5) },
      { n:6, title:'Kaolack → Toubacouta', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:7, title:'Delta du Saloum', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 1) },
      { n:8, title:'Joal-Fadiouth → Saly & départ', tone:'terre', mood:'portrait', img: IMG('Delta du Saloum', 2) },
    ] },

  { id:'bassari-bedik-12j', title:'Pays BASSARI & BEDIK — rites de passage', subtitle:'12 jours · Sénégal oriental, immersion & cérémonies',
    days:12, nights:11, priceXOF:null, tone:'forest', mood:'horizon',
    badges:['Aventure','Immersion','Sénégal oriental'],
    short:'Douze jours dans le Sénégal oriental, hôtes des sociétés BASSARI et BEDIK du Fouta Djalon : safari au Niokolo-Koba, villages perchés d’Iwol et d’Etiolo, maîtres d’initiation et rites de passage, chutes de Dindéfélo — une immersion culturelle rare.',
    route:'Dakar → Niokolo-Koba → Kédougou → pays BASSARI & BEDIK',
    types:['aventure','nature','culture'], tier:'confort', start:'dakar', destIds:['dakar','kedougou','saloum'], popularity:79,
    img: IMG('Kédougou', 2),
    itinerary:[
      { n:1, title:'Dakar', tone:'dusk', mood:'city', img: IMG('Dakar', 8) },
      { n:2, title:'Dakar → Tambacounda → Wassadou', tone:'ocre', mood:'horizon', img: IMG('Kédougou', 1) },
      { n:3, title:'Safari au Niokolo-Koba', tone:'forest', mood:'horizon', img: IMG('Kédougou', 3) },
      { n:4, title:'Niokolo → Kédougou → Iwol', tone:'forest', mood:'leaves', img: IMG('Kédougou', 4) },
      { n:5, title:'Pays BEDIK (Iwol)', tone:'ocre', mood:'portrait', img: IMG('Kédougou', 5) },
      { n:6, title:'Kédougou → pays BASSARI → Etiolo', tone:'forest', mood:'horizon', img: IMG('Kédougou', 6) },
      { n:7, title:'Etiolo → pays BEDIK → Kédougou', tone:'terre', mood:'portrait', img: IMG('Kédougou', 2) },
      { n:8, title:'Kédougou & chutes de Dindéfélo', tone:'forest', mood:'water', img: IMG('Casamance', 3) },
      { n:9, title:'Kédougou → Tambacounda → Toubacouta', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 7) },
      { n:10, title:'Delta du Saloum', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 1) },
      { n:11, title:'Delta du Saloum', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 5) },
      { n:12, title:'Toubacouta → Saly & départ', tone:'terre', mood:'portrait', img: IMG('Delta du Saloum', 2) },
    ] },

  { id:'medecine-traditionnelle-10j', title:'Sur les traces des guérisseurs', subtitle:'10 jours · médecine traditionnelle, du Saloum à la Casamance',
    days:10, nights:9, priceXOF:null, tone:'forest', mood:'leaves',
    badges:['Thématique','Rencontres','Immersion'],
    short:'Dix jours à la découverte de la médecine traditionnelle sénégalaise : herboristes des marchés de Dakar, thérapie Ndepp, guérisseurs ostéopathes du Saloum, Saltigués et Xoy à Fatick, tradipraticiens de Casamance — un voyage de rencontres et de savoirs.',
    route:'Dakar → Saloum → Casamance → Saly',
    types:['culture','nature'], tier:'confort', start:'dakar', destIds:['dakar','goree','lac-rose','saloum','casamance'], popularity:76,
    img: IMG('Casamance', 2),
    itinerary:[
      { n:1, title:'Dakar', tone:'dusk', mood:'city', img: IMG('Dakar', 7) },
      { n:2, title:'Dakar & Gorée', tone:'terre', mood:'horizon', img: IMG('Ile de gorée', 2) },
      { n:3, title:'Dakar → Lac Rose → Djilor', tone:'rose', mood:'water', img: IMG('Lac Rose', 3) },
      { n:4, title:'Djilor & le Saloum', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:5, title:'Djilor → Fatick → Toubacouta', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 7) },
      { n:6, title:'Toubacouta → Ziguinchor', tone:'forest', mood:'leaves', img: IMG('Casamance', 1) },
      { n:7, title:'Kénia & Bignona', tone:'forest', mood:'leaves', img: IMG('Casamance', 4) },
      { n:8, title:'Oussouye & Cap Skirring', tone:'atlant', mood:'water', img: IMG('Casamance', 5) },
      { n:9, title:'Ziguinchor → Saly', tone:'ocre', mood:'horizon', img: IMG('Delta du Saloum', 3) },
      { n:10, title:'Saly & départ', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 5) },
    ] },

  { id:'best-sene-gambia-11j', title:'Le meilleur de la Sénégambie', subtitle:'11 jours · Sénégal oriental & fleuve Gambie',
    days:11, nights:10, priceXOF:null, tone:'atlant', mood:'water',
    badges:['2 pays','Safari fluvial','Nature'],
    short:'Onze jours entre Sénégal et Gambie : mégalithes de Kaffrine, réserve de Kédougou et chutes de Dindéfélo, puis une croisière jour et nuit sur le fleuve Gambie — hippopotames, crocodiles et plus de 500 espèces d’oiseaux — jusqu’aux plages de Saly.',
    route:'Dakar → Kédougou → fleuve Gambie → Saly',
    types:['nature','aventure','culture'], tier:'confort', start:'dakar', destIds:['dakar','goree','kedougou','saloum'], popularity:81,
    img: IMG('Kédougou', 4),
    itinerary:[
      { n:1, title:'Dakar', tone:'dusk', mood:'city', img: IMG('Dakar', 8) },
      { n:2, title:'Dakar & Gorée', tone:'terre', mood:'horizon', img: IMG('Ile de gorée', 8) },
      { n:3, title:'Dakar → Tambacounda', tone:'ocre', mood:'horizon', img: IMG('Kédougou', 1) },
      { n:4, title:'Tambacounda → Kédougou', tone:'forest', mood:'horizon', img: IMG('Kédougou', 2) },
      { n:5, title:'Kédougou & chutes de Dindéfélo', tone:'forest', mood:'water', img: IMG('Casamance', 3) },
      { n:6, title:'Kédougou → Georgetown (Gambie)', tone:'sand', mood:'horizon', img: IMG('Kédougou', 5) },
      { n:7, title:'Croisière sur le fleuve Gambie', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 1) },
      { n:8, title:'Georgetown → Tendaba', tone:'forest', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:9, title:'Tendaba', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 7) },
      { n:10, title:'Tendaba → Kaolack → Saly', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 3) },
      { n:11, title:'Saly & départ', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 5) },
    ] },

  { id:'sene-gambia-mauritanie-15j', title:'Sénégambie & Mauritanie', subtitle:'15 jours · du désert maure au fleuve Gambie',
    days:15, nights:14, priceXOF:null, tone:'ocre', mood:'dunes',
    badges:['3 pays','Désert','Grand voyage'],
    short:'Quinze jours et trois pays : Gorée et le Lac Rose, Saint-Louis et le Djoudj, une nuit sous la tente bédouine dans le désert mauritanien et Nouakchott, le delta du Saloum, puis la Gambie de Juffureh (Kunta Kinteh) — jusqu’au safari de Bandia.',
    route:'Dakar → Saint-Louis → Mauritanie → Saloum → Gambie → Saly',
    types:['aventure','culture','nature','diaspora'], tier:'premium', start:'dakar', destIds:['dakar','goree','lac-rose','saint-louis','saloum'], popularity:88,
    img: IMG('Désert de Lompoul', 2),
    itinerary:[
      { n:1, title:'Dakar', tone:'dusk', mood:'city', img: IMG('Dakar', 7) },
      { n:2, title:'Gorée & Lac Rose', tone:'rose', mood:'water', img: IMG('Lac Rose', 2) },
      { n:3, title:'Lac Rose → Thiès → Saint-Louis', tone:'terre', mood:'city', img: IMG('Saint-Louis', 2) },
      { n:4, title:'Parc du Djoudj & Saint-Louis', tone:'atlant', mood:'water', img: IMG('Saint-Louis', 5) },
      { n:5, title:'Saint-Louis → désert de Mauritanie', tone:'ocre', mood:'dunes', img: IMG('Désert de Lompoul', 3) },
      { n:6, title:'Nouakchott', tone:'sand', mood:'horizon', img: IMG('Désert de Lompoul', 1) },
      { n:7, title:'Nouakchott → Saint-Louis → Kaolack', tone:'terre', mood:'horizon', img: IMG('Saint-Louis', 3) },
      { n:8, title:'Kaolack → Toubacouta', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:9, title:'Îles du delta du Saloum', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 1) },
      { n:10, title:'Toubacouta → Banjul (Gambie)', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 7) },
      { n:11, title:'Fleuve Gambie & Juffureh', tone:'terre', mood:'portrait', img: IMG('Ile de gorée', 3) },
      { n:12, title:'Banjul & Kanilai', tone:'forest', mood:'leaves', img: IMG('Casamance', 1) },
      { n:13, title:'Katchikally', tone:'forest', mood:'water', img: IMG('Casamance', 3) },
      { n:14, title:'Banjul → Saly', tone:'ocre', mood:'horizon', img: IMG('Delta du Saloum', 3) },
      { n:15, title:'Réserve de Bandia & départ', tone:'sand', mood:'horizon', img: IMG('Kédougou', 3) },
    ] },

  { id:'senegal-guinee-15j', title:'Sénégal & Guinée', subtitle:'15 jours · du fleuve au Fouta Djalon',
    days:15, nights:14, priceXOF:null, tone:'forest', mood:'horizon',
    badges:['2 pays','Fouta Djalon','Grand voyage'],
    short:'Quinze jours du Sénégal à la Guinée : Gorée, le Lac Rose, Saint-Louis et le Djoudj, le safari du Niokolo, puis les montagnes du Fouta Djalon — Labé, Dalaba, les chutes de Ditinn et du Voile de la Mariée — jusqu’à Conakry et les îles de Loos.',
    route:'Dakar → Saint-Louis → Niokolo → Fouta Djalon → Conakry',
    types:['aventure','nature','culture'], tier:'premium', start:'dakar', destIds:['dakar','goree','lac-rose','saint-louis','kedougou'], popularity:80,
    img: IMG('Casamance', 3),
    itinerary:[
      { n:1, title:'Dakar', tone:'dusk', mood:'city', img: IMG('Dakar', 8) },
      { n:2, title:'Dakar & Gorée', tone:'terre', mood:'horizon', img: IMG('Ile de gorée', 8) },
      { n:3, title:'Dakar → Lac Rose → Saint-Louis', tone:'rose', mood:'water', img: IMG('Lac Rose', 3) },
      { n:4, title:'Saint-Louis & parc du Djoudj', tone:'atlant', mood:'water', img: IMG('Saint-Louis', 5) },
      { n:5, title:'Saint-Louis → Sine Saloum', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 2) },
      { n:6, title:'Sine Saloum → Niokolobadiar', tone:'ocre', mood:'horizon', img: IMG('Kédougou', 1) },
      { n:7, title:'Safari au Niokolobadiar', tone:'forest', mood:'horizon', img: IMG('Kédougou', 3) },
      { n:8, title:'Niokolobadiar → Labé (Guinée)', tone:'forest', mood:'leaves', img: IMG('Kédougou', 6) },
      { n:9, title:'Labé', tone:'forest', mood:'leaves', img: IMG('Casamance', 5) },
      { n:10, title:'Labé → Dalaba', tone:'forest', mood:'water', img: IMG('Casamance', 3) },
      { n:11, title:'Dalaba → Linsan', tone:'forest', mood:'leaves', img: IMG('Casamance', 2) },
      { n:12, title:'Chutes du Voile de la Mariée', tone:'atlant', mood:'water', img: IMG('Casamance', 4) },
      { n:13, title:'Dubréka → Conakry', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:14, title:'Îles de Loos', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 1) },
      { n:15, title:'Conakry & départ', tone:'dusk', mood:'city', img: IMG('Dakar', 2) },
    ] },

  { id:'gold-coast-15j', title:'Gold Coast Explorer', subtitle:'15 jours · Côte d’Ivoire, Ghana, Togo & Bénin',
    days:15, nights:14, priceXOF:null, tone:'terre', mood:'horizon',
    badges:['4 pays','Route des esclaves','Vodou'],
    short:'Quinze jours le long du golfe de Guinée, à travers quatre pays : Grand-Bassam et Abidjan, les forts d’Elmina et de Cape Coast au Ghana, Lomé et les pays Tamberma au Togo, puis le Bénin vodou — Abomey, Ganvié la cité lacustre et Ouidah.',
    route:'Abidjan → Accra → Lomé → Cotonou',
    types:['culture','aventure','diaspora'], tier:'premium', start:'autre', destIds:[], popularity:74,
    img: IMG('Ile de gorée', 5),
    itinerary:[
      { n:1, title:'Abidjan', tone:'dusk', mood:'city', img: IMG('Dakar', 6) },
      { n:2, title:'Abidjan & Grand-Bassam', tone:'terre', mood:'city', img: IMG('Dakar', 2) },
      { n:3, title:'Grand-Bassam → Axim → Cape Coast', tone:'atlant', mood:'water', img: IMG('Casamance', 5) },
      { n:4, title:'Cape Coast → Accra', tone:'terre', mood:'horizon', img: IMG('Ile de gorée', 6) },
      { n:5, title:'Accra → Lomé', tone:'dusk', mood:'city', img: IMG('Dakar', 7) },
      { n:6, title:'Lomé → Atakpamé', tone:'forest', mood:'leaves', img: IMG('Casamance', 2) },
      { n:7, title:'Atakpamé → Kara', tone:'ocre', mood:'horizon', img: IMG('Kédougou', 2) },
      { n:8, title:'Kara → chutes de Tanougou (Bénin)', tone:'forest', mood:'water', img: IMG('Casamance', 3) },
      { n:9, title:'Tanougou → Natitingou', tone:'ocre', mood:'horizon', img: IMG('Kédougou', 6) },
      { n:10, title:'Natitingou → Parakou', tone:'sand', mood:'horizon', img: IMG('Kédougou', 1) },
      { n:11, title:'Parakou → Abomey → Bohicon', tone:'terre', mood:'portrait', img: IMG('Ile de gorée', 3) },
      { n:12, title:'Bohicon → Ganvié → Ouidah', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:13, title:'Ouidah → Cotonou', tone:'terre', mood:'horizon', img: IMG('Ile de gorée', 7) },
      { n:14, title:'Cotonou → Porto-Novo', tone:'dusk', mood:'city', img: IMG('Dakar', 5) },
      { n:15, title:'Cotonou & départ', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 5) },
    ] },
...
const EXCURSIONS = [
  ...
  { id:'lac-rose-halfday', title:'Lac Rose — Demi-journée', subtitle:'Sel et dunes blanches',
    ...
    short:"Le Lac Rose (Retba), un des phénomènes naturels les plus rares au monde. Reflets roses du lac dus aux micro-organismes et à la forte salinité, sur fond de dunes de sable blanc. Rencontre avec les ramasseuses de sel et les villages PEULS environnants.",
  ...
  { id:'saloum-islands-fullday', title:'Îles du Saloum — Journée', subtitle:'Mar Lodj, Dionewar, pêcheurs NIOMINKAS',
  ...
  { id:'saly-bandia-halfday', title:'Réserve de Bandia — Safari', subtitle:'Antilopes, buffles, rhinocéros blancs',
    kind:'half', start:'saly', days:1, nights:0, priceXOF:null, tone:'ocre', mood:'horizon',
    schedule:'Matinée · safari 1h30',
    short:"Départ après petit-déjeuner à travers la forêt de baobabs de Sindia jusqu'à la réserve de Bandia. Safari en véhicule 4x4 avec guide spécialiste de la faune : antilopes-chevaux, buffles, crocodiles, phacochères, singes, girafes, rhinocéros blancs, gazelles, oiseaux.",
...
const CIRCUIT_DETAIL = {
  ...
  days: [
    ...
    { n:3, title:'Lac Rose — sel & dunes', short:'Route vers le lac, rencontre avec les ramasseuses de sel, baignade salée, nuit en lodge au bord de l’eau.', tone:'rose', mood:'water', img: IMG('Lac Rose', 6) },
