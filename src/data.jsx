...
const CIRCUITS = [
  ...
  // ---- CIRCUITS MULTI-JOURS RÉELS ------------------------------------------
  // Source : brochure officielle ACT « NEW BOOK ANGLAIS » (traitée juil. 2026).
  // Programmes jour par jour fidèles à la brochure. Pas de notes/avis
  // inventés (rating/reviews absents tant qu'il n'y a pas d'avis réels) ;
  // prestations incluses/exclues génériques tant qu'ACT n'a pas transmis le
  // détail par circuit. `itinerary` alimente la fiche /tour/:id.
  { id:'saint-louis-2j', title:'Saint-Louis', subtitle:'2 jours · cité UNESCO & parc du Djoudj',
    days:2, nights:1, priceXOF:null, tone:'terre', mood:'city',
    badges:['Guide local','Calèche','UNESCO'],
    short:'La route de Thiès et sa manufacture de tapisseries, puis Saint-Louis l’historique : palais du Gouverneur, balcons de fer forgé, calèche dans Guet Ndar. Au matin du deuxième jour, le sanctuaire du Djoudj — plus d’un million d’oiseaux au fil de l’eau.',
    route:'Dakar → Thiès → Saint-Louis → Djoudj',
    types:['culture','nature'], tier:'confort', start:'dakar', destIds:['saint-louis'], popularity:92,
    img: IMG('Saint-Louis', 2),
    itinerary:[
      { n:1, title:'Dakar → Thiès → Saint-Louis', short:'Départ matinal avec halte à Thiès : son grand marché de tissus africains et d’herbes médicinales, la Manufacture des arts décoratifs et ses tapisseries d’exception, villages de campagne en chemin. Arrivée à Saint-Louis à midi, déjeuner dans le centre historique. À 16h, tour de la ville : palais du Gouverneur, place Faidherbe, marché de Ndar Toute, maisons coloniales aux balcons de fer forgé. En calèche, quartier pittoresque des pêcheurs de Guet Ndar et cimetière marin. Dîner et nuit à l’hôtel.', tone:'terre', mood:'city', img: IMG('Saint-Louis', 4) },
      { n:2, title:'Saint-Louis → parc du Djoudj → Dakar', short:'Petit-déjeuner puis cap sur le sanctuaire ornithologique du Djoudj, site UNESCO de 16 000 hectares de zones humides. En bus puis en pirogue : pélicans, flamants, vautours de Rüppell, aigles pêcheurs — un défilé de nature. Déjeuner dans le parc, retour vers Dakar avec haltes dans les villages et marchés traditionnels.', tone:'atlant', mood:'water', img: IMG('Saint-Louis', 5) },
    ] },

  { id:'gambie-2j', title:'Gambie — Banjul & Juffureh', subtitle:'2 jours · fleuve, bac & mémoire de « Racines »',
    days:2, nights:1, priceXOF:null, tone:'atlant', mood:'water',
    badges:['Guide local','Diaspora','2 pays'],
    short:'Cap au sud jusqu’à Banjul par les villages mandingues et le bac sur le fleuve Gambie. Au retour, Juffureh — le village de Kunta Kinteh, rendu célèbre par « Racines » d’Alex Haley.',
    route:'Dakar → Banjul → Juffureh → Dakar',
    types:['culture','diaspora'], tier:'confort', start:'dakar', destIds:['saloum'], popularity:84,
    img: IMG('Delta du Saloum', 2),
    itinerary:[
      { n:1, title:'Dakar → Banjul', short:'Départ le matin vers la Gambie par Rufisque, Mbour et Kaolack. Visite des villages mandingues de Sokone, Karang et Barra, puis traversée pittoresque du fleuve Gambie en bac jusqu’à Banjul, la capitale. Tour de la ville avant l’installation à l’hôtel. Dîner et nuit à Banjul.', tone:'dusk', mood:'city', img: IMG('Delta du Saloum', 6) },
      { n:2, title:'Banjul → Juffureh → Dakar', short:'Après le petit-déjeuner, nouvelle traversée du fleuve à la rencontre des ethnies de ses rives, jusqu’à Juffureh, sur la rive nord : le village natal de Kunta Kinteh, l’ancêtre d’Alex Haley, que son best-seller « Racines » a fait connaître au monde. Visite du village, puis route du retour vers Dakar avec déjeuner dans la région du Saloum.', tone:'terre', mood:'portrait', img: IMG('Ile de gorée', 3) },
    ] },

  { id:'saint-louis-touba-3j', title:'Saint-Louis & Touba', subtitle:'3 jours · patrimoine, fleuve & ville sainte',
    days:3, nights:2, priceXOF:null, tone:'terre', mood:'city',
    badges:['Guide local','UNESCO','Rencontres'],
    short:'Trois jours entre héritage colonial et islam confrérique : le Lac Rose et Thiès en route, Saint-Louis l’UNESCO en calèche, une cérémonie folklorique à Makhana, puis Touba et sa grande mosquée sous la conduite d’un dignitaire mouride.',
    route:'Dakar → Lac Rose → Saint-Louis → Touba',
    types:['culture'], tier:'confort', start:'dakar', destIds:['saint-louis','lac-rose'], popularity:90,
    img: IMG('Saint-Louis', 3),
    itinerary:[
      { n:1, title:'Dakar → Lac Rose → Thiès → Saint-Louis', short:'Départ par le célèbre Lac Rose (Retba) : reflets roses sur les dunes blanches, récolteurs de sel et éleveurs semi-nomades peuls des villages voisins. Continuation vers Thiès, deuxième ville du pays réputée pour ses arts et son artisanat — marché aux tissus et herbes traditionnelles, déjeuner sur place. Route de Saint-Louis par les villages wolof et leurs marchés hebdomadaires. Verre de bienvenue, dîner et nuit à l’hôtel.', tone:'rose', mood:'water', img: IMG('Lac Rose', 3) },
      { n:2, title:'Saint-Louis, ancienne capitale', short:'Journée consacrée à la visite de l’ancienne capitale du Sénégal et de l’Afrique-Occidentale française, classée au patrimoine mondial de l’UNESCO : palais du Gouverneur, maisons coloniales aux balcons de fer forgé, cimetière des pêcheurs, quartier de Guet Ndar — en partie en calèche. Sur demande, déjeuner chez une famille saint-louisienne. L’après-midi, village traditionnel de Makhana : cérémonie folklorique en votre honneur, chants, danses et lutte sénégalaise. Dîner et nuit à l’hôtel.', tone:'terre', mood:'city', img: IMG('Saint-Louis', 6) },
      { n:3, title:'Saint-Louis → Touba → Dakar', short:'Route vers Touba, la plus célèbre destination de pèlerinage musulman d’Afrique de l’Ouest, fondée par Cheikh Ahmadou Bamba. Accueilli par l’un des guides spirituels de la confrérie mouride, vous découvrez la grande mosquée — la plus vaste et la plus belle de la région — puis la bibliothèque aux milliers d’ouvrages du saint homme. Déjeuner partagé dans la plus pure tradition d’hospitalité, puis retour à Dakar par les villages.', tone:'sand', mood:'horizon', img: IMG('Dakar', 5) },
    ] },

  { id:'saloum-lac-rose-toubacouta-3j', title:'Saloum — Lac Rose & Toubacouta', subtitle:'3 jours · delta UNESCO, îles & traditions',
    days:3, nights:2, priceXOF:null, tone:'atlant', mood:'water',
    badges:['Guide local','Famille bienvenue','UNESCO'],
    short:'Du Lac Rose au delta du Saloum : Joal-Fadiouth et son cimetière aux coquillages, soirée folklorique à Toubacouta, barbecue de poisson sur une île déserte et rencontre d’une guérisseuse traditionnelle.',
    route:'Dakar → Lac Rose → Joal → Toubacouta',
    types:['nature','culture','famille'], tier:'confort', start:'dakar', destIds:['saloum','lac-rose'], popularity:88,
    img: IMG('Delta du Saloum', 3),
    itinerary:[
      { n:1, title:'Dakar → Lac Rose → Joal-Fadiouth → Toubacouta', short:'Le matin, visite du Lac Rose et des villages peuls semi-nomades qui l’entourent. Route vers le sud-ouest par Diamniadio, la forêt de baobabs de Bandia et Mbour. Déjeuner à Joal, puis après-midi à Fadiouth : le village, son cimetière aux coquillages, ses greniers sur pilotis, et la rencontre des anciens et notables. Par Foundiougne et les villages sérères, arrivée à Toubacouta, au cœur du delta du Saloum classé UNESCO. Dîner animé de folklore et de danses, nuit à l’hôtel.', tone:'rose', mood:'water', img: IMG('Lac Rose', 4) },
      { n:2, title:'Toubacouta — le fleuve & les îles', short:'Matinée en pirogue sur le fleuve Saloum : sanctuaires d’oiseaux, îles de pêcheurs, rencontre des Niominkas. À midi, barbecue de poisson sur une île déserte, face à une plage à couper le souffle. L’après-midi, autres sites du delta et village de Missirah, où une guérisseuse traditionnelle renommée partage son savoir sur la médecine traditionnelle et sa place dans la société sénégalaise. Retour à l’hôtel, dîner et nuit.', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 7) },
      { n:3, title:'Toubacouta → Fatick → Dakar', short:'Après le petit-déjeuner, route du retour à travers les villages de brousse et leurs ethnies. Halte à Fatick à la rencontre des Saltigués, guérisseurs et devins, qui vous parlent du Xoy — la grande cérémonie divinatoire sérère. Déjeuner à Ndangane, temps libre sur la plage, puis retour à Dakar en fin d’après-midi.', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 5) },
    ] },

  { id:'saloum-kaolack-sipo-3j', title:'Saloum — Kaolack & Sipo', subtitle:'3 jours · bolongs, villages mandingues & Joal',
    days:3, nights:2, priceXOF:null, tone:'forest', mood:'water',
    badges:['Guide local','Nature','Pirogue'],
    short:'La variante orientale du delta : Kaolack et son grand marché, les villages mandingues, la remontée des bolongs jusqu’au village de pêcheurs de Sipo, et Joal-Fadiouth au retour.',
    route:'Dakar → Kaolack → Toubacouta → Sipo',
    types:['nature','culture'], tier:'confort', start:'dakar', destIds:['saloum'], popularity:82,
    img: IMG('Delta du Saloum', 4),
    itinerary:[
      { n:1, title:'Dakar → Kaolack → Toubacouta', short:'Départ à 8h vers Kaolack par la vieille ville coloniale de Rufisque, Diamniadio et la forêt de baobabs de Sindia ; à Mbour, les séchoirs à poissons et leur procédé traditionnel. Déjeuner à Kaolack, puis à 14h route de Toubacouta à travers les villages mandingues. Arrivée en fin d’après-midi. Dîner et nuit au lodge.', tone:'ocre', mood:'horizon', img: IMG('Delta du Saloum', 1) },
      { n:2, title:'Toubacouta → Sipo', short:'Après le petit-déjeuner, navigation sur le fleuve Saloum : sanctuaires d’oiseaux, îles de villages de pêcheurs. Escale au village de pêcheurs de Sipo, à la rencontre des communautés sérères et niominkas. Retour à Toubacouta en début d’après-midi. Dîner et nuit au lodge.', tone:'atlant', mood:'water', img: IMG('Delta du Saloum', 6) },
      { n:3, title:'Toubacouta → Joal-Fadiouth → Dakar', short:'Petit-déjeuner à 7h puis route vers Saly via Foundiougne. À Joal-Fadiouth, exploration du village de Fadiouth, du cimetière aux coquillages et des greniers sur les dunes blanches, avec les anciens et notables. Déjeuner à Joal, puis Mbour — ancien village de pêcheurs devenu ville bouillonnante. Arrivée à Dakar dans l’après-midi.', tone:'terre', mood:'portrait', img: IMG('Delta du Saloum', 2) },
    ] },

  { id:'niokolo-koba-3j', title:'Parc du Niokolo-Koba', subtitle:'3 jours · safari dans 900 000 hectares',
    days:3, nights:2, priceXOF:null, tone:'forest', mood:'horizon',
    badges:['Safari','Guide spécialisé','Aventure'],
    short:'La grande réserve du Sénégal : lions, éléphants, hippopotames, buffles, crocodiles, panthères… Deux safaris guidés par un spécialiste local de la zone, au cœur d’une nature intacte de 900 000 hectares.',
    route:'Dakar → Tambacounda → Wassadou',
    types:['nature','aventure'], tier:'confort', start:'dakar', destIds:['kedougou'], popularity:80,
    img: IMG('Kédougou', 2),
    itinerary:[
      { n:1, title:'Dakar → Tambacounda → Wassadou', short:'Départ à 7h vers Simenti par Mbour, Kaolack, Kaffrine et Tambacounda, avec la visite de villages traditionnels en route. Déjeuner à Tamba, puis continuation vers Missirah, Badi et Wassadou — premier contact avec la faune et la végétation du parc. Dîner et nuit au lodge de Wassadou.', tone:'ocre', mood:'horizon', img: IMG('Kédougou', 1) },
      { n:2, title:'Safari dans le Niokolo', short:'Petit-déjeuner au lodge puis départ matinal pour une journée complète de safari à la découverte de la très riche faune du parc. À midi, retour au lodge pour le déjeuner et un peu de repos. L’après-midi, second safari dans d’autres zones de la réserve. Dîner et nuit au lodge.', tone:'forest', mood:'horizon', img: IMG('Kédougou', 3) },
      { n:3, title:'Niokolo → Kaolack → Dakar', short:'Dernier regard sur le parc après le petit-déjeuner, puis route du retour par Tambacounda et Kaolack, où le déjeuner est servi. L’après-midi, visite de Fatick, des villages peuls de la palmeraie de Samba Dia, de Mbour et de la forêt de baobabs de Sindia. Arrivée à Dakar en fin d’après-midi.', tone:'sand', mood:'horizon', img: IMG('Delta du Saloum', 5) },
    ] },

  { id:'casamance-mandingue-4j', title:'Casamance & pays mandingue', subtitle:'4 jours · royaume d’Oussouye, Karabane & Gambie',
    days:4, nights:3, priceXOF:null, tone:'forest', mood:'leaves',
    badges:['Guide local','Rencontres','2 pays'],
    short:'Le grand sud en profondeur : le roi d’Oussouye et les maîtres d’initiation, les cases à impluvium d’Enampore, l’île de Karabane en pirogue par la mangrove, et le retour par Banjul.',
    route:'Dakar → Ziguinchor → Karabane → Banjul',
    types:['nature','culture','aventure'], tier:'confort', start:'dakar', destIds:['casamance'], popularity:87,
    img: IMG('Casamance', 2),
    itinerary:[
      { n:1, title:'Dakar → Kaolack → Ziguinchor', short:'Route vers Ziguinchor, capitale de la célèbre région méridionale de Casamance, par la forêt de baobabs de Sindia, Kaolack et son marché animé, et les villages peuls. Déjeuner en route, traversée de la Gambie, puis visite de villages mandingues avant l’arrivée en fin d’après-midi. Dîner et nuit à l’hôtel.', tone:'ocre', mood:'horizon', img: IMG('Casamance', 1) },
      { n:2, title:'Ziguinchor — coutumes & traditions', short:'Journée dédiée aux coutumes de Casamance : rencontre du chef traditionnel mandingue, le roi d’Oussouye, et des maîtres des cérémonies d’initiation des villages. Échanges avec les communautés diola, baïnouk et mankagne. L’après-midi, l’architecture mandingue, respectueuse de la nature : les cases à impluvium d’Enampore et les maisons de terre à étage de Seleti. Dîner et nuit à Ziguinchor.', tone:'forest', mood:'leaves', img: IMG('Casamance', 3) },
      { n:3, title:'Ziguinchor → île de Karabane → Ziguinchor', short:'Découverte de la basse Casamance : villages diola jusqu’au port de pêche d’Elinkine, puis traversée en pirogue motorisée vers l’île de Karabane, au fil du fleuve — oiseaux, mangrove, bancs d’huîtres et pirogues colorées des pêcheurs. Déjeuner au restaurant du couvent, puis visite de l’île, de son histoire et des témoignages de l’époque de la traite dans le sud du Sénégal. Retour à Ziguinchor en fin de journée. Dîner et nuit à l’hôtel.', tone:'atlant', mood:'water', img: IMG('Casamance', 5) },
      { n:4, title:'Ziguinchor → Banjul → Dakar', short:'Départ après le petit-déjeuner vers Banjul, capitale de la Gambie, à travers les villages de haute Casamance. Tour de ville et déjeuner à Banjul, puis traversée du fleuve Gambie en bac et remontée par la région du Saloum. Arrivée à Dakar en fin d’après-midi.', tone:'dusk', mood:'city', img: IMG('Delta du Saloum', 3) },
    ] },

  // ---- Circuit vitrine (fiche type détaillée — voir CIRCUIT_DETAIL) ----
  { id:'goree-lac-saloum', title:'Gorée · Lac Rose · Saloum', subtitle:'Mémoire, sel & mangrove',
    ...
    route:'Dakar → Gorée → Lac Rose → Saloum',
...
const BLOG = [
  ...
  { id:'goree-emotion', title:'Préparer sa visite de Gorée : ce que personne ne vous dit',
    ...
    body:[
      ...
      { type:'p', html:'Si Gorée vous touche, notre programme <a href="/tour/diaspora-premium-10j/">Retour aux sources</a> approfondit la dimension mémorielle, avec rencontres d’historien·ne·s et cérémonie d’accueil traditionnelle. Pour les voyageurs qui veulent simplement passer une journée — l’<a href="/tour/excursion-goree/">Excursion Gorée</a> reste notre formule la plus demandée.' },
    ] },
  ...
  { id:'casamance-sentiers', title:'Casamance hors des sentiers battus — 5 villages à découvrir',
    ...
    body:[
      ...
      { type:'p', html:'Vol Dakar - Cap Skirring (1h) ou Dakar - Ziguinchor (1h). Voiture privée ensuite. Notre circuit <a href="/tour/casamance-mandingue-4j/">Casamance & pays mandingue</a> couvre Ziguinchor, Oussouye, Enampore et l’île de Karabane sur 4 jours — et se prolonge sur mesure.' },
    ] },
  { id:'diaspora-prepa', title:'Préparer son premier voyage en tant qu’afro-descendant·e',
    ...
    body:[
      ...
      { type:'h2', text:'Pour aller plus loin' },
      { type:'p', html:'Notre programme <a href="/tour/diaspora-premium-10j/">Retour aux sources</a> est pensé spécifiquement pour ce voyage : Gorée en profondeur, rencontre généalogique, cérémonie d’accueil, photographe sur tout le séjour. Sur mesure de votre histoire.' },
    ] },
  ...
  { id:'enfants-senegal', title:'Voyager au Sénégal avec des enfants : ce qui marche, ce qu’on évite',
    ...
    body:[
      ...
      { type:'callout', title:'Votre voyage en famille', html:'Nous composons votre <a href="/custom/">voyage familial sur mesure</a> autour de ces neuf points : journées courtes, hôtels familiaux, baignades, ateliers cuisine et artisanat, et un guide habitué aux enfants.' },
  ...
  { id:'lompoul-nuit', title:'Lompoul : à quoi ressemble vraiment une nuit dans les dunes',
    ...
    body:[
      ...
      { type:'p', html:'Notre circuit <a href="/tour/saint-louis-2j/">Saint-Louis · 2 jours</a> enchaîne avec l’architecture coloniale et le parc du Djoudj — la formule idéale pour le nord. Une nuit dans les dunes de Lompoul s’y ajoute <a href="/custom/">sur mesure</a>, en chemin entre Dakar et Saint-Louis.' },
    ] },
];
...
if (typeof window !== 'undefined') Object.assign(window, {
  DESTINATIONS, CIRCUITS, EXCURSIONS, ATELIERS, CROISIERES, TESTIMONIALS, TOUR_REVIEWS,
  BLOG, BLOG_CATEGORIES, INSTA,
